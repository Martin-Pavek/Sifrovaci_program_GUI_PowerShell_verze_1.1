...
<#   
postup kompilace do *.exe nasledujici :
soubor ps2exe.ps1 otevrit v PowerShell ISE (tzn. editoru)
na spodnim radku v prikazove konzoly "doskakat" az k zdrojovemu souboru 
zda napriklad potebuju zkompilovat soubor desifrovat_v6.ps1

takze zadam E: <enter> tim se prepnu na disk E:\
soubor se nachazi primo v korenovem adresari takze netreba nic dalsiho
pokud ne tak puzivam prikaz "cd NazevSlozky" pro prepnuti do jineho adresare (vsechno funguje normalne jako ve starym MS-Dosu)
kdyz jsem ve slozce kde chci pracovat napisu prikaz "dir" vypise se me obsah adresare (taky klasika, nic noveho)
pozn. o adresar niz se dostanu prikazem "cd .."
tento program tzn. ps2exe.ps1 napred spustim ! (aby si nacetl vsech potrebne prommene a funce do enviromentu !)
tzn. budto kvavesa F5 nebo zelena sipka nahore, program napise "Ready" (nic vic)

nyni opisu tyto dva prikazy a za kazdym zmacku klavesu <enter>

Invoke-ps2exe .\zasifruj.ps1 .\zasifruj.exe
Invoke-ps2exe .\desifruj.ps1 .\desifruj.exe
Invoke-ps2exe .\zobraz_tip.ps1 .\zobraz_tip.com



Invoke-ps2exe .\zasifrovat_v6.ps1 .\zasifrovat_v6.exe
Invoke-ps2exe .\zasifrovat_v7.ps1 .\zasifrovat_v7.exe
Invoke-ps2exe .\desifrovat_v6.ps1 .\desifrovat_v6.exe
Invoke-ps2exe .\desifrovat_v7.ps1 .\desifrovat_v7.exe



program vypise hlaseni Compiling file...
Output file ...
